...
class FeatureAligner(nn.Module):
    def __init__(self, input_dim=256, hidden_dim=256, output_dim=128, mode="train"):
    ...
    '''
    def load_model(self):
        curr_model = "/home/minkycho/adafuse/results_adafuse/train600_cali100_val150/fusion_elsumffn_od6ep_wh6ep_4gpus.pth"
        print("=" * 50)
